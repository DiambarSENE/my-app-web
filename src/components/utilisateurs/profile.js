...
import { AppContextEmailByToken, AppContextRole, AppContextRoleByToken, AppContextToken, AppContextUserByEmail } from "../../useContext/contextStateUser";
import { getAuthToken, getUserByEmail, updatePassword, updateUser } from "../../servicesApi/microservice-utilisateur";
...
function Profile(){
    ...
    const handlerUpdatePass = (e) => {
        ...
        if(passwordNew){
            if (password1 || confirmerPassword){
                if(password1 === confirmerPassword){
                   let updatePass = {email, passwordNew, confirmerPassword};
    ...
    useEffect(() => {
        ...
        findUserByEmail(stateUserByEmail)
    ...
    const handlerUpdateUser = (e) => {
        e.preventDefault();
        let user = { id, prenom, nom, telephone, matricule, email, userCreate, isActivated};
                                             ...
                                             <div className="modal-body">
                                                 ...
                                                 <div className="col-lg-12">
                                                     <div className="mb-3">
                                                         ...
                                                         <input type="password" className="form-control" name="password" value={passwordNew} onChange={(e) => setPasswordNew(e.target.value)} placeholder="Votre ancien mot de passe"  />
                                                     ...
                                                     <div className="mb-3">
                                                         ...
                                                         <input value={password1} onChange={(e) => setPassword1(e.target.value)} type="password" className="form-control" placeholder="Nouveau mot de passe"/>
                                     ...
                                     <div className="tab-content">
                                         ...
                                         */}
                                         ...
                                         <div className="profile-personal-info">
                                             ...
                                             <div className="col-sm-9 col-7"><span>pas de adresse</span>
                                             </div>
                                             </div>
                                         </div>
                                         </div>
